...
def evaluate(args, model, device, test_loader):
    ...
    with torch.no_grad():
        ...
        np.save('./probs_svhn_mc.npy', pred_probs_mc)
        np.save('./svhn_test_labels_mc.npy', target_labels)
    ...
    if args.mode == 'train':
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            torch.save(model.state_dict(),
                       args.save_dir + "/svhn_bayesian_scnn.pth")

    elif args.mode == 'test':
        checkpoint = args.save_dir + '/svhn_bayesian_scnn.pth'
